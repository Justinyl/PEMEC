...
def build_memcap(sl = 20):
    ...
    def _Eq1(m, n):
        ...
        """
        # if (n == m.n.first()):
        #     return ( (m.ua[n]*m.Ca['H2O',n] - m.ua_0*m.Ca0['H2O'])/m.dz + \
    ...
    def _Eq3(m, n):
        ...
        """
        # if (n == m.n.first()):
        #     return ( (m.ua_0*m.Ca0['O2'] - m.ua[n]*m.Ca['O2',n])/m.dz - \
    ...
    def _Eq4(m, n):
            ...
            """
            # if (n == m.n.first()):
            #     return ( (m.ua_0*m.Ca0['H2'] - m.ua[n]*m.Ca['H2',n])/m.dz - \
...
with pd.ExcelWriter('Model_V1_5_output.xlsx') as writer:  
