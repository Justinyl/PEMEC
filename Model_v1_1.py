...
"""
This version generally follow the v1_equations

The electro-osmosis is set to 0 here and the flux is set at a cosntant
"""
...
def build_memcap(sl = 20):
    ...
    m.u_in = Param(initialize = 3, doc = 'velocity(m/min)')     
    ...
    m.j_avg = Param(m.n, initialize = 1, doc = 'Average current density')
    ...
    # Coefficient 
    m.D_H2 = Param(initialize = 1.15e-7, doc = 'diffusivity of hydrogen: 1.15e-7 (m^2/s)') # function of T
    ...
    #     """
    #     return sum(m.j[n] for n in m.n) == j_avg
